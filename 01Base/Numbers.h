...
#define SLCr64M_PI (4.0*atan(1.0))
#define SLCr32M_PI  (4.0f*atanf(1.0f))
#define SLCr32deg2rad(__deg)  (SLCr32M_PI * __deg / 180.0f)
#define SLCr64deg2rad(__deg)  (SLCr64M_PI * __deg / 180.0)
#define SLCr32cos(__a) cosf(__a)
#define SLCr32sin(__a) sinf(__a)
#define SLCr64cos(__a) cos(__a)
#define SLCr64sin(__a) sin(__a)
#define SLCr32acos(__a) acosf(__a)
#define SLCr32asin(__a) asinf(__a)
#define SLCr64acos(__a) acos(__a)
#define SLCr64asin(__a) asin(__a)
#define SLCc64cos(__a) ccosf(__a)
#define SLCc64sin(__a) csinf(__a)
#define SLCc128cos(__a) ccos(__a)
#define SLCc128sin(__a) csin(__a)
#define SLCr32sqrt(__a) sqrtf(__a)
#define SLCr64sqrt(__a) sqrt(__a)
#define SLCc64sqrt(__a) csqrtf(__a)
#define SLCc128sqrt(__a) csqrt(__a)
